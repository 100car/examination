"""
STEP 10 | Аналіз одного SKU по 3 регіонах (UA/KZ/UZ) на основі *-normalized
...
Запуск:
!python DATA/step10_sku_region_analysis.py
"""
...
def main() -> None:
    ...
    _print_banner("STEP 10 | Аналіз одного SKU по регіонах (UA/KZ/UZ)")
