"""
STEP 12 | ML (supervised): прогноз TOTAL за профілем продажів (RandomForest)
...
Запуск:
!python DATA/step12_ml_regression_total.py
"""
...
def main() -> None:
    ...
    _print_banner("STEP 12 | ML: RandomForestRegressor (прогноз TOTAL)")
    ...
    if X.shape[0] < 30:
        print("WRN | STEP 12 | Дуже мало спостережень для стабільного ML. Результати можуть бути шумними.")
