"""
STEP 11 | K-means кластеризація SKU (PR-) на основі *-normalized
...
Запуск:
!python DATA/step11_kmeans_clustering.py
"""
...
def main() -> None:
    ...
    _print_banner("STEP 11 | KMeans кластеризація SKU (PR-)")
    ...
    if data.shape[0] < 10:
        print("WRN | STEP 11 | Дуже мало SKU для кластеризації. Перевір filters.include_prefixes.")
        return
